...
const CancelPendingBookingModal = () => {
    ...
    const handleCancel = async () => {
        ...
        try {
            ...
            await cancelBookingPending(bookingId, reason);
            ...
            setToast(error.message || 'Lỗi khi hủy đơn hàng');
        } finally {
...
export default CancelPendingBookingModal; 